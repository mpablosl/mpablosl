...
![JavaScript](https://img.shields.io/badge/JavaScript-Automação-yellow)
![Cypress](https://img.shields.io/badge/Cypress-Automação-green)
![GitHub](https://img.shields.io/badge/GitHub-Portfólio-black)
![Git](https://img.shields.io/badge/Git-Controle%20de%20Versão-red)
![Scrum](https://img.shields.io/badge/Scrum-Metodologia%20Ágil-purple)
![SQL](https://img.shields.io/badge/SQL-Validação%20de%20Dados-blue)
![Postman](https://img.shields.io/badge/Postman-Testes%20de%20API-orange)
![Jira](https://img.shields.io/badge/Jira-Gestão%20de%20Defeitos-blue)
...
## Objetivo
Demonstrar a criação, execução e documentação profissional de Casos de Teste, bem como a automação de fluxos funcionais críticos de um e-commerce, aplicando os princípios e técnicas do ISTQB CTFL 4.0.

## Principais Práticas e Habilidades
- **Modelagem de Testes:** Planejamento e escrita de cenários de teste aplicando técnicas como Particionamento de Equivalência e Análise de Valor Limite.
- **Testes Manuais:** Execução de testes funcionais, validação de regras de negócio e registro de evidências.
- **Cobertura End-to-End (E2E):** Validação dos fluxos completos de Autenticação (Login), Inventário (Carrinho) e Checkout.
- **Automação de Testes:** Desenvolvimento de scripts automatizados rápidos e confiáveis utilizando o framework Cypress.
...
* Auditoria de ativos e processos
...
[LinkedIn - Pablo Soares Lopes](https://www.linkedin.com/in/pablosl/)

## GitHub

[GitHub - mpablosl](https://github.com/mpablosl)
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=mpablosl\&show_icons=true)

![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=mpablosl\&layout=compact)
